...
export default function TextForm(props) {
  ...
  <div className="form-group">
    <textarea className="form-control" value={text} onChange={handleOnChange} placeholder="Enter the text"style={{backgroundColor:props.theme==="light"?"white":"grey" ,color:props.theme==="light"?"black":"white" }}id="mybox" rows="8"></textarea>
  </div>
  ...
  <button disabled={text.split(" ").filter((word)=>word==="").length<2} className="btn btn-primary mx-1 my-1" id="myButton2"onClick={handleeOnClick3}>Remove Extra space</button>
